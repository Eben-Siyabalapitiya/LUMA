...
- [`BOM.csv`](BOM.csv) / [`BOM.md`](BOM.md) : full parts list with links and rough CAD prices
- [`docs/WIRING.md`](docs/WIRING.md) : wiring diagram plus a pin-by-pin table for the TFT and both touch sensors
- [`CAD/`](CAD/README.md) : the printed enclosure : STEP files for every part, the `LUMA_V3.3mf` print file, and the Onshape link
...
files, and the step-by-step assembly guide.
